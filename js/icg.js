/*@@Description 
JS file that handles all javascript on the menuboards. Includes retriving data, checking for update, promo initialization etc. This is deprecated and not used. Use icg-MCDV2.js
      ...
      allContent:{
            ...
            getContent:function(){
                  ...
                  if(icg.getParams['store_nid']){
                        params.preview_store_id = icg.getParams['store_nid'];
                  }
